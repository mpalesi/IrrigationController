...
#define CONFIG_IRRIGATION_TARGET_IRRIGATION_CONTROLLER 1
#define CONFIG_IRRIGATION_WIFI_SSID "casabianca_first"
#define CONFIG_IRRIGATION_WIFI_PASSWORD "nonteladico"
